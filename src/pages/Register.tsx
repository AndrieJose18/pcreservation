    ...
    return (
        <IonPage>
            <IonContent className="ion-padding">
                ...
                >
                    <IonCard style={{ width: '100%', maxWidth: '420px', padding: '20px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
                        <IonCardHeader>
                            <IonCardTitle className="ion-text-center">Create Your Account</IonCardTitle>
                        </IonCardHeader>
                        <IonCardContent>
                            ...
                            <IonButton onClick={handleOpenVerificationModal} expand="block" shape="round" style={{ marginTop: '15px' }}>
                                Register
                            </IonButton>
                            <IonButton routerLink="/pcreservation" expand="block" fill="clear" shape="round">
                ...
                <IonModal isOpen={showSuccessModal} onDidDismiss={() => setShowSuccessModal(false)}>
                    <IonContent className="ion-padding" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '100vh', textAlign: 'center', marginTop: '35%' }}>
                        ...
                        <IonButton routerLink="/pcreservation" routerDirection="back" color="primary">
                            Go to Login
                        </IonButton>
                    </IonContent>
                </IonModal>
